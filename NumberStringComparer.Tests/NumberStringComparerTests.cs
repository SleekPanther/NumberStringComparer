...
#pragma warning restore 8625
	...
	public void NumberStringComparerSort_Tests() {
		...
		var standardKeys1 = new List<string>
		{
			"OH_Alt-SC-v3:NS|6.NS.c3|M.6.10",
			"OH_Alt-SC-v3:NS|6.NS.c3|M.6.11",
			"OH_Alt-SC-v3:NS|6.NS.c3|M.6.8",
		};
		standardKeys1.Sort(NumberStringComparer<string>.GetComparer());
		var expectedStandardKeys1 = new List<string>
		{
			"OH_Alt-SC-v3:NS|6.NS.c3|M.6.8",
			"OH_Alt-SC-v3:NS|6.NS.c3|M.6.10",
			"OH_Alt-SC-v3:NS|6.NS.c3|M.6.11",
		};
		Assert.Equal(expectedStandardKeys1, standardKeys1);

		var standardKeys2 = new List<string>
		{
			"5.ESS.1",
			"8.ESS.1",
			"5.ESS.2",
		...
		var expectedStandardKeys2 = new List<string>
		{
			"5.ESS.1",
			"5.ESS.2",
			"8.ESS.1",
		...
		standardKeys2.Sort(NumberStringComparer<string>.GetComparer());
		Assert.Equal(expectedStandardKeys2, standardKeys2);
	}
