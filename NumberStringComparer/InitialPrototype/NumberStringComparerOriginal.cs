...
public sealed class NumberStringComparerOriginal<T> : IComparer<T>
{
	...
	private NumberStringComparerOriginal() { }
	private NumberStringComparerOriginal(string propertyName) {
		this.propertyName = propertyName;
	}
	private static readonly ConcurrentDictionary<string, NumberStringComparerOriginal<T>> comparers = new();
	...
	public static NumberStringComparerOriginal<T> GetComparer() {
		Type type = typeof(T);
		...
		return comparers.GetOrAdd(type.FullName!, _ => new NumberStringComparerOriginal<T>());
	}
	public static NumberStringComparerOriginal<T> GetObjectComparer(string propertyName) {
		...
		if (comparer == null) {
			...
			comparer = new NumberStringComparerOriginal<T>(propertyName);
		}
		return comparer;
	}
